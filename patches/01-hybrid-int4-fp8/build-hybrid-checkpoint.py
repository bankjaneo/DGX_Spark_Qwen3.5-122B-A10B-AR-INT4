#!/usr/bin/env python3
"""
Build a hybrid GPTQ-INT4 + FP8 checkpoint for Qwen3.5-397B-A17B.
...
Usage:
    python build-hybrid-checkpoint.py \
        --gptq-dir  ~/inference/models/hf/qwen3.5-397b-a17b-gptq-int4 \
        --fp8-repo  Qwen/Qwen3.5-397B-A17B-FP8 \
        --output    ~/inference/models/hf/qwen3.5-397b-a17b-fp8hybrid
"""
